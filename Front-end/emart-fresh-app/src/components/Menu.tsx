    ...
    <>
      <div>
        <div
          className={`${styles.menuHeader} ${
            isOpen ? styles.headerAnimaition : ""
          }`}
        >
        ...
        <div
          className={`${styles.secondBack} ${
            isOpen ? styles.secondAnimation : ""
          }`}
        ></div>
        <div
          className={`${styles.firstBack} ${
            isOpen ? styles.firstAnimation : ""
          }`}
        >
          1
        </div>
      ...
      <div className={styles.mainMenu}>
        <div
          ...
          onClick={() => {
            navigate("/show-all-product"), setIsOpen(false);
          }}
        >
        ...
        <div
          className={styles.menuList}
          onClick={() => {
            navigate("/search-store"), setIsOpen(false);
          }}
        >
        ...
        <div
          className={styles.menuList}
          onClick={() => {
            navigate("/eventlist"), setIsOpen(false);
          }}
        >
      ...
      <div className={styles.subMenu}>
        <div
          ...
          onClick={() => {
            navigate("/login"), setIsOpen(false);
          }}
        >
          <FontAwesomeIcon
        ...
        <div
          className={styles.subList}
          onClick={() => {
            navigate("/mypageMain"), setIsOpen(false);
          }}
        >
          <FontAwesomeIcon icon={faUser} className={styles.menuIcon} />
          마이페이지
          {/* <ToggleComponent initialOpen={true} /> */}
        </div>
        <div
          className={styles.subList}
          onClick={() => {
            navigate("/cart"), setIsOpen(false);
          }}
        >
